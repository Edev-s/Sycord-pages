...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (isJSON) fileRules = `- Return valid JSON only. package.json MUST include "@heroui/react": "^2" (NOT ^1), "framer-motion": "^11", "react": "^19", "react-dom": "^19", "vite": "^6", "typescript": "^5" in dependencies. CRITICAL: @heroui/react version 1.x does NOT exist — always use "^2".`
