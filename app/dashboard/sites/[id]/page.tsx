  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className={cn("flex-1 relative flex flex-col", activeTab === "ai" ? "p-0 overflow-hidden" : "overflow-y-auto overflow-x-hidden p-4 md:p-6 lg:p-8 custom-scrollbar")}>
          <div className={cn(activeTab === "ai" ? "h-full w-full" : "mx-auto max-w-6xl space-y-8 pb-10")}>
