      ...
      <main className="w-full flex-1 flex flex-col">
        ...
        <section className="relative w-full overflow-visible min-h-[75vh] md:min-h-[70vh] pb-32 md:pb-40">
          ...
          <div className="relative z-10 flex flex-col justify-start h-full px-6 md:px-8 pt-12 md:pt-20 pb-12 max-w-6xl mx-auto">
            ...
            <div className="relative overflow-hidden mb-6 max-w-md">
              <div className="flex animate-marquee">
                {[...Array(2)].map((_, repeatIdx) => (
                  <div key={repeatIdx} className="flex items-center gap-12 shrink-0 px-6">
                    {/* GitHub */}
                    <svg className="h-5 w-5 opacity-30 shrink-0" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
