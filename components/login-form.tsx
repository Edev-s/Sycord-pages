...
import { ArrowLeft, Shield, Zap, Globe, Loader2, CheckCircle2 } from "lucide-react"
    ...
    <div className="min-h-screen bg-background flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-md">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground mb-6 sm:mb-8 transition-colors group"
          >
            <ArrowLeft className="h-4 w-4 transition-transform group-hover:-translate-x-1" />
            Vissza a főoldalra
          </Link>

          <div className="border border-border rounded-xl sm:rounded-2xl p-6 sm:p-8 bg-card shadow-lg backdrop-blur-sm transition-all duration-300 hover:shadow-xl">
            <div className="flex items-center gap-3 mb-6 sm:mb-8">
              <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl bg-primary/10 flex items-center justify-center transition-transform duration-300 hover:scale-105">
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              <Button
                ...
                variant="outline"
                className={cn(
                  "w-full bg-white text-black hover:bg-gray-50 border-gray-200 h-12 sm:h-14 relative rounded-xl text-sm sm:text-base font-medium transition-all hover:shadow-md disabled:opacity-70",
                  isLoading && "cursor-wait",
                  loginSuccess && "bg-green-50 border-green-200"
                )}
              >
                {isLoading ? (
                  <>
                    <Loader2 className="h-5 w-5 sm:h-6 sm:w-6 mr-2 sm:mr-3 animate-spin text-gray-600" />
                    <span className="text-gray-600">Bejelentkezés...</span>
                  </>
                ) : loginSuccess ? (
                  <>
                    <CheckCircle2 className="h-5 w-5 sm:h-6 sm:w-6 mr-2 sm:mr-3 text-green-600" />
                    <span className="text-green-600">Sikeres! Átirányítás...</span>
                  </>
                ) : (
                  <>
          ...
          <div className="flex items-center justify-center gap-2 mt-6 text-muted-foreground">
            ...
            <span className="text-[10px] sm:text-xs">256-bit SSL titkosítás</span>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-md space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4 group">
              <div className="h-12 w-12 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0 transition-all duration-300 group-hover:bg-primary/20 group-hover:scale-105">
